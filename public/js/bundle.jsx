...
/***/ function(module, exports, __webpack_require__) {
	...
	var PersonList = __webpack_require__(160);
	...
	var App = React.createClass({
	  ...
	  _handleCardClick: function _handleCardClick(name, e) {
	    alert(name);
	  },

	  render: function render() {
	    return React.createElement(PersonList, { people: this.state.people, onCardClick: this._handleCardClick });
	  }
	});
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      this.props.people.map(function (person) {
	        return React.createElement(
	          'div',
	          { key: person.name, style: styles.card, onClick: _this.props.onCardClick.bind(null, person.name) },
	          person.name
	        );
	      })
	    );
